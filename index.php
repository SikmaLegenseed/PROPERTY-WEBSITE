...
<body>
    <nav>
        <img src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_272x92dp.png" alt="Google Logo" width="150px" height="50px">
        <ul>
            <li>Home</li>
            <li>Contact</li>
        </ul>
    ...
    <div class="container">
        <div class="img-main">
            <img src="img/rumah-2.jpg" alt="Outdoor Lamps" width="100%" height="646px">
